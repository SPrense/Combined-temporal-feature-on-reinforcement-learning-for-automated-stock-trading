...
class DRLEnsembleAgent:
    ...
    def __init__(
        ...
        # self.attn_indicator_list = attn_indicator_list
    ...
    def DRL_prediction(
        self, model, name, last_state, iter_num, initial
    ):
        ...
        trade_env = DummyVecEnv(
            [
                lambda: StockTradingEnv(
                    ...
                    # attn_indicator_list = self.attn_indicator_list,
    ...
    def run_ensemble_strategy_com(
        self, SAC_model_kwargs, PPO_model_kwargs, TD3_model_kwargs, timesteps_dict
    ):
        """Ensemble Strategy that combines PPO, A2C and DDPG"""
        print("============Start Ensemble Strategy============")
        # for ensemble model, it's necessary to feed the last state
